package com.example.mapkit_map_objects
...
class MainActivity : AppCompatActivity(), MapObjectTapListener {
    ...
    override fun onMapObjectTap(mapObject: MapObject, point: Point): Boolean {
        if (mapObject is CircleMapObject) {
            ...
            Toast.makeText(applicationContext,"Latitude ${point.latitude} \n " +
                    "Longtitude ${point.longitude}" , Toast.LENGTH_SHORT).show()
        }
        return true
    }

    private class CircleMapObjectUserData internal constructor(val id: Int, val description: String)
